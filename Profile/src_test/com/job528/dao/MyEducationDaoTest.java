...
public class MyEducationDaoTest extends SpringDao{
	static IMyEducationDao dao;
	
	@BeforeClass
	public void testInit() {
		dao = super.getMyEducationDao();
	...
	public void testGetUsersLastEducation() {
		...
		List<MyEducation> list = dao.getUsersLastEducation(userIds);
		
		System.out.println("list=="+list.size());
		for(MyEducation e : list) {
			PrintBean.PrintBeanProperty(e);
		}
