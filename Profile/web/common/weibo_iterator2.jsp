...
<!-- 转发信息 E -->
<!-- 操作 S -->
	<p class="operate" style=" clear:both;">
		...
		<a href="javascript:void(0);" onclick="$('#comment_${weibo.id}').focus();" class="blues" >评论<s:if test="weibo.commentNumber>0">(${weibo.commentNumber})</s:if></a>
		</span>
	</p>
<!-- 操作  E -->
<div class="clear"></div>
<!-- 评论 S -->
    <div id="commentBox_${weibo.id}" class="comments" style="display:">
...
<input id="weiboId" type="hidden" value="${weibo.id}" />
</dl>
<div id="commentList_${weibo.id}" class="comment_box_dw">
<%@ include file="/common/comment_iterator.jsp" %>
</div>
