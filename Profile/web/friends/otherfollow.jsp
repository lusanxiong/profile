...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>${myResume.perName}关注的-${myResume.perName}的人脉</title>
		...
		<div class="people_box">
			<div class="people">
				<div class="people_tle">
					<ul>
				    <li style="display: none;"><a href="search.shtml"><b>搜朋友</b></a></li>
					<li><a href="otherfollow.shtml?uid=${myResume.myUserId}" class="bhover"><b class="chover">${myResume.perName}关注的</b></a></li>
					<li><a href="otherfans.shtml?uid=${myResume.myUserId}"><b>关注${myResume.perName}的</b></a></li>
                    <li style="display: none;"><a href="invite.jsp"><b>好友</b></a></li>
					</ul>
				</div>
			</div>
            ...
            <span class="plgz"><a href="javascript:void(0);" onclick="batchAttention();" class="ble">批量关注</a></span>
           </div>
            <c:forEach items="${friends.list}" var="friend">
           	    	...
           	    	<div class="block" duid="${friend.friend.userId}">
                        ...
                        <div class="con">
                            ...
                            <span class="txt">${friend.speciality}</span>
                              ...
                              <div class="dw">${friend.friend.flag}自我介绍：${friend.introduction} </div>
                      </div> 
                            <div class="jgz">
                            <c:choose>
             ...
             <form action="otherfollow.shtml?uid=${myResume.myUserId}" method="post" name="thisForm">
