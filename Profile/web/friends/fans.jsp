		...
		<div class="people_box">
			<div class="people">
				<div class="people_tle">
					...
					<li><a href="fans.shtml" class="bhover"><b class="chover">关注我的</b></a></li>
            ...
            <span class="plgzs"><a href="javascript:void(0);" class="ble" onclick="batchdelfans();">批量移除粉丝</a></span>
            <span class="line">|</span>
            <span class="plgzs"><a href="javascript:void(0);" class="ble" onclick="batchSendPrivateMsg('私信群发')">批量发私信</a></span></div>
            <c:forEach items="${friends.list}" var="friend"> 
            	<div class="people_con_lists" id="_li${friend.friend.userId}"> <c:if test=""></c:if>
                       ...
                       <span class="ycfs" id="_f_add${friend.friend.userId}"><img src="${basePath}/images/hot_concern.gif" height="17" onclick="attention(${friend.friend.userId});"/></span>
                       <span class="ycfs" id="_f_each${friend.friend.userId}" style="display: none;"><img src="${basePath}/images/eachother.gif" height="16" /></span>
                       </c:if>
                       <c:if test="${friend.followEach}">
                        <span class="ycfs" id="_f_add" style="display: none;"><img src="${basePath}/images/hot_concern.gif" height="17" onclick="attention(${friend.friend.userId});"/></span>
                       <span class="ycfs" id="_f_each"><img src="${basePath}/images/eachother.gif" height="16" /></span>
                       </c:if>
                       <span class="ycfs" ><a href="javascript:void(0);" class="ble" onclick="delFans(${friend.friend.userId});">移除粉丝</a></span>
                       <span class="ycfs" ><a href="javascript:void(0);" class="ble" onclick="sendMyMsg({userName:'${friend.userInfo.name}',userId:'${friend.friend.userId}'})">发私信</a></span>
                            </div>
            		</div>  
            	</div>
              </c:forEach>  
               <form action="followMe.shtml" method="post" name="thisForm">
