 ...
 * http://www.webdesignerwall.com/demo/jquery/animated-hover1.html 渐出效果
...
$.blockUI.defaults = {
    ...
    css: { 
        ...
        textAlign:      'center', 
        color:          '#000', 
        border:         '', //对话框的边框颜色4px solid #aaa
        backgroundColor:'',
        cursor:         'default' //对话框鼠标样式wait
    },
    
    // styles for the overlay
    overlayCSS:  { 
        backgroundColor:'', //遮罩层颜色#D9D9D9 #000 #fff
        opacity:        '0.3' 
    },
...
function install(el, opts) {
    ...
    var lyr2 = $('<div class="blockUI" style="z-index:1001;cursor:defalut;border:none;margin:0;padding:0;width:100%;height:100%;top:0;left:0"></div>');
