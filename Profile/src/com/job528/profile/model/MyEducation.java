...
/**
 * MyEducation entity. @author MyEclipse Persistence Tools
 */

public class MyEducation implements java.io.Serializable {
	...
	/** minimal constructor */
	public MyEducation(Integer id, Integer myUserId) {
		this.id = id;
		this.myUserId = myUserId;
	}

	/** full constructor */
	public MyEducation(Integer id, Integer myUserId, Short degreeId,
