 ...
 *
 */
public class UserAccessHistoryInfoDTO implements Serializable{
	...
	private String accessUserPost;//访问用户职务名名称
	private Date accessDate;//访问日期
	private String accessDateStr;//访问日期字符串格式
	...
	public void setNowPlaceName(String nowPlaceName) {
		if(nowPlaceName != null){
			nowPlaceName = nowPlaceName.replaceAll(",", " ");
		}
	...
	public String getAccessUserPost() {
		return accessUserPost;
	}
	public void setAccessUserPost(String accessUserPost) {
